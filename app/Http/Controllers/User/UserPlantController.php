...
class UserPlantController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('user.plants.index')->with('success', 'Plant updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('user.plants.index')->with('success', 'Plant and its varieties deleted successfully.');
    }
