    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href=" {{ route('aggregator.dashboard')}} ">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    {{ optional(auth()->user())->first_name }} <!-- Display the user's first name -->

                                    <h6 style="font-size: 10px;">
                                        @if (strtoupper(optional(auth()->user())->role) === 'ADMIN')
                                            ADMINISTRATOR
                                        @elseif (strtoupper(optional(auth()->user())->role) === 'AGGREGATOR')
                                            AGGREGATOR
                                        @else
                                            USER
                                        @endif
